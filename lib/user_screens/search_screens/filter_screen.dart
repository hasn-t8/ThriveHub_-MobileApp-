...
//                   color: Colors.black,
//                   height: 1.5625, // Line height (24.96px / 16px)
//                   letterSpacing: 0.38,
...
//                                       ? Colors.white
//                                       : Colors.black,
//                                   height: 1.923, // 25px line height / 13px font size
//                                   letterSpacing: 0.38,
//                                 ),
//                               ),
//                               if (selectedFilters.contains(option))
...
//                   fixedSize: const Size(343, 54), // Fixed width and height
//                   shape: RoundedRectangleBorder(
//                     borderRadius: BorderRadius.all(Radius.circular(16),
//                     ),
//                   ),
//                   side: BorderSide(
//                     color: Color(0xFFA5A5A5), // Border color #A5A5A5
//                     width: 1,
//                   ),
//                   padding: const EdgeInsets.fromLTRB(19, 17, 19, 17), // Padding for button content
//                   elevation: 0, // Remove shadow
//                 ),
//                 onPressed: () {
//                   Navigator.pop(context, selectedFilters.toList());
//                 },
//                 child: Row(
...
//                         height: 1.25, // Line height (20px line height / 16px font size)
//                         letterSpacing: 0.38, // Optional, if you want spacing
//                         decoration: TextDecoration.none, // No text decoration
//                       ),
//                     ),
//                     const SizedBox(width: 8), // Spacing between the text and the count
//                     if (selectedFilters.isNotEmpty)
//                       Text(
//                         '(${selectedFilters.length})', // Display number in brackets
//                         style: const TextStyle(
//                           fontFamily: 'Inter',
//                           fontSize: 16,
//                           fontWeight: FontWeight.w500,
//                           color: Colors.white, // White color for the number
//                         ),
//                       ),
//                   ],
//                 ),
